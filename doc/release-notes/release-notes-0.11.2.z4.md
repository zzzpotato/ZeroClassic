...
Jack Grigg (21):
      ...
      Add Zero revision to version strings
      Bitcoin -> Zero in version and help text
      Add Zero Developers to CLI copyright notice
...
Nathan Wilcox (1):
      Fix a test name bug so that ``make cov-zero`` correctly runs the ``zero-gtest`` binary. Fixes #946.
...
Taylor Hornby (16):
      ...
      Turn on -Werror for the Zero build.
