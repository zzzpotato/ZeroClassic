...
Jack Grigg (24):
      ...
      Handle full Zero version string in AC_INIT
...
Sean Bowe (28):
      ...
      Use base58check to encode Zero payment addresses, such that the first two bytes are "zc".
      Add tests for `CZCPaymentAddress`.
      Fix test against merkle tree root.
      Added encoding for Zero spending keys.
