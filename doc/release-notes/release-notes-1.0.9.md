...
Jack Grigg (14):
      ...
      Convert Zero versions to Debian format
      ...
      Implement automatic shutdown of deprecated Zero versions
...
Jay Graber (2):
      Change help text examples to use Zero addresses
...
Nathan Wilcox (39):
      ...
      Add all of the zero release tags in my current repo as positive test vector.
      ...
      Reuse zero_rpc.
      Do not use `-rpcwait` on all `zero_rpc` invocations, only block when starting zerod.
