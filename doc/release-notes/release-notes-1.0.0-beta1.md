...
Lars-Magnus Skog (1):
      changed module name from "bitcoin" to "Zero" in FormatException()
...
Simon (91):
      ...
      Reduce use of global pzeroParams with private member variable
      Revert "Reduce use of global pzeroParams with private member variable"
      Replace zeroParams_ with global.
