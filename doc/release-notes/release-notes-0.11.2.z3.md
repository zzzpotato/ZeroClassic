...
Nathan Wilcox (4):
      ...
      Add coverage support scoped to only the zero-gtest run; invoke with make zero-cov; make cov is a superset.
...
Sean Bowe (49):
      ...
      Introduce new `libzero` Zero protocol API and crypto constructions surrounding the zkSNARK circuit.
...
Taylor Hornby (7):
      ...
      Fix RPC tests
      Rename bitcoin.conf and bitcoind.pid to zero.conf and zerod.pid in qa/ and src/
