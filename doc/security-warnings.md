...
Zero has been subjected to a formal third-party security review. For security
...
This implementation of Zero is not resistant to side-channel attacks. You
...
in [issue #826](https://github.com/zero/zero/issues/826), and believe that we
