...
The Zero daemon can be configured to act as a trusted "border
router", implementing the Zero P2P protocol and relay, making
...
The AMQP feature in Zero requires [Qpid Proton](https://qpid.apache.org/proton/)
...
TLS support may be added once OpenSSL has been removed from the Zero
