...
} // end namespace `libzero`

typedef libzero::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libzero::SHA256Compress> ZCIncrementalMerkleTree;
typedef libzero::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzero::SHA256Compress> ZCTestingIncrementalMerkleTree;

typedef libzero::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libzero::SHA256Compress> ZCIncrementalWitness;
typedef libzero::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libzero::SHA256Compress> ZCTestingIncrementalWitness;
