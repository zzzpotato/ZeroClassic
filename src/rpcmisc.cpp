...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total Zero balance of the wallet\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"zeroaddress\"\n"
            "\nReturn information about the given Zero address.\n"
            "\nArguments:\n"
            "1. \"zeroaddress\"     (string, required) The Zero address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"zeroaddress\",   (string) The Zero address validated\n"
...
UniValue z_validateaddress(const UniValue& params, bool fHelp)
{
    ...
    try {
        ...
        libzero::PaymentAddress addr = address.Get();
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"zeroaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"zeroaddress\"    (string, required) The Zero address to use for the signature.\n"
