...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("ZeroClassic zero-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zero-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ZeroClassic transaction") + "\n" +
              "  zero-tx [options] -create [commands]   " + _("Create hex-encoded ZeroClassic transaction") + "\n" +
              "\n";
