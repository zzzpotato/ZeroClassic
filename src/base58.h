...
class CZCPaymentAddress : public CZCEncoding<libzero::PaymentAddress, CChainParams::ZCPAYMENT_ADDRRESS, libzero::SerializedPaymentAddressSize> {
protected:
...
public:
    ...
    CZCPaymentAddress(const libzero::PaymentAddress& addr) { Set(addr); }
};

class CZCViewingKey : public CZCEncoding<libzero::ViewingKey, CChainParams::ZCVIEWING_KEY, libzero::SerializedViewingKeySize> {
protected:
...
public:
    ...
    CZCViewingKey(const libzero::ViewingKey& vk) { Set(vk); }
};

class CZCSpendingKey : public CZCEncoding<libzero::SpendingKey, CChainParams::ZCSPENDING_KEY, libzero::SerializedSpendingKeySize> {
protected:
...
public:
    ...
    CZCSpendingKey(const libzero::SpendingKey& addr) { Set(addr); }
};
